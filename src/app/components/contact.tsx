...
const Contact = () => {
  return (
    <section className="flex flex-col gap-12 bg-[#121d29] px-8 py-12 sm:px-12 sm:py-20 md:gap-16 md:px-16 md:py-28 md:text-4xl lg:gap-20 lg:px-24 lg:py-36 xl:px-32 xl:py-48 2xl:px-48 2xl:py-40">
      <div className="flex max-w-screen-2xl flex-col gap-12 md:gap-16 lg:flex-row lg:gap-20 xl:gap-36 2xl:gap-48">
